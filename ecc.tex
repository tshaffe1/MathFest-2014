...
\begin{document}
    ...
    \begin{frame}[label=projective]
        ...
        \hyperlink{points}{\beamergotobutton{Proof}}
        \vfill
    ...
    \begin{frame}[label=forms]
        ...
        \hyperlink{maps}{\beamergotobutton{Mappings}}
    \end{frame}
    ...
    \begin{frame}[label=add]
        ...
        \begin{theorem}
            ...
            \end{align*}
        \end{theorem}
        \hyperlink{addproof}{\beamergotobutton{Proof}}
    \end{frame}
    ...
    \begin{frame}[label=ecdh]
        ...
        \begin{algorithm}
            ...
            \end{itemize}
        \end{algorithm}
        \hyperlink{ecdhexample}{\beamergotobutton{Example}}
    \end{frame}
    ...
    \begin{frame}[label=elgamal]
        ...
        \begin{decryption}
            ...
            M + [kb]P - [bk]P = M\).
        \end{decryption}
        \hyperlink{elgamalexample}{\beamergotobutton{Example}}
    \end{frame}
    ...
    \begin{frame}[label=points]
        ...
        \begin{proof}
            ...
            is \[q^2 + q + 1.\]
        \end{proof}
        \hyperlink{projective}{\beamergotobutton{Back}}
    \end{frame}
    ...
    \begin{frame}[label=maps]
        ...
        \begin{align*}
            ...
            &\phi([b_0, b_1, \dots, b_n]) =
                ...
                \frac{b_n}{b_0}\right)
        \end{align*}
        \hyperlink{forms}{\beamergotobutton{Back}}
    \end{frame}
    ...
    \begin{frame}
        ...
        so
        \[P + Q = S = (g', -h').\]
        \hyperlink{add}{\beamergotobutton{Back}}
    \end{frame}
    ...
    \begin{frame}[label=ecdhexample]
        ...
        \begin{algorithm}
            ...
            \end{itemize}
        \end{algorithm}
        \hyperlink{ecdh}{\beamergotobutton{Back}}
    \end{frame}
    ...
    \begin{frame}[label=elgamalexample]
        ...
        \end{decryption}
        \hyperlink{elgamal}{\beamergotobutton{Back}}
    \end{frame}
\end{document}
